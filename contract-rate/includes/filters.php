    ...
    <div class="row justify-content-between">
        <div class="pb-4 col-12 col-md-auto">
            <div class="row g-2">
                <div class="col-auto">
                    <div class="dropdown">
                        <button type="button" class="btn dropdown-toggle border bg-white rounded-0 fs-9" id="btnRatesAvailability" data-bs-toggle="dropdown" aria-expanded="false">
                            All Rates &amp; Availability
                        </button>
                        <ul class="dropdown-menu rounded-0 fs-9" aria-labelledby="btnRatesAvailability">
                            ...
                            <li>
                                <div class="py-2 px-3">
                                    <div class="border-top fs-9 pt-2 fw-bold text-dark text-nowrap">
                                        Channel management
                                    </div>
                                </div>
                            </li>
                ...
                <div class="col-auto">
                    <div class="dropdown">
                        <button type="button" class="btn dropdown-toggle border bg-white rounded-0 fs-9" id="btnRoomTypes" data-bs-toggle="dropdown" aria-expanded="false">
                            All Room Types
                        </button>
        ...
        <div class="pb-3 col-12 col-md-auto">
            <div class="row g-2">
                <div class="col-auto">
                    <button class="btn btn-primary rounded-0 fs-9" data-bs-toggle="modal" data-bs-target="#generateModal">
                        Generate
                    </button>
                </div>
                <div class="col-auto">
