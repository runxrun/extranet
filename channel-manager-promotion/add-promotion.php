...
<div class="-collapse" id="collapseSetPromotion">
	...
	<div class="py-4">	
		<div class="row justify-content-between">		
			<div class="col-auto">
				<button class="btn btn-secondary rounded-0 py-2 fs-8 text-white" onclick="window.open('/channel-manager-promotion/','_self');">
			...
			<div class="col-auto">
				...
				<div class="row g-2 justify-content-end">
					...
					<div class="col-auto">
						<button class="btn btn-success rounded-0 py-2 fs-8 text-white" onclick="window.open('/channel-manager-promotion/?page=add-promotion','_self');">
